...
BOOL func_184(var uParam0) // Position - 0xC39F
{
	if (*uParam0 == 29)
	{
		if (func_227(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if (!func_185(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
int func_186(var uParam0) // Position - 0xC465
{
	if (*uParam0 == 28)
	{
		if (func_227(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if (!func_185(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 4f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_201() || Global_32286 || func_200() || func_199(8, -1) || func_197() || func_100() || func_198() || func_196() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_201() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_199(8, -1) || func_196() || func_195() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDE0A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
int func_216(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDE2B
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_227(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFC15
{
...
BOOL func_273(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x102D2
{
...
BOOL func_274(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1032E
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_320(echParam1);
...
int func_320(eCharacter echParam0) // Position - 0x1151C
{
	if (!func_36(echParam0))
