...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x29CD
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
eCharacter func_125(int iParam0) // Position - 0x50E8
{
	eCharacter i;
	int num;
	eCharacter character;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x58A8
{
...
void func_146() // Position - 0x5D37
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_100554))
	{
		if (func_37(CHAR_LAMAR) == unk_0x4B423FAA24E8ABF0(Global_100554))
