...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x28236
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x28F5E
{
...
BOOL func_257(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x293FA
{
	int i;
	var unk;
	int num;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2AD0E
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_306(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B171
{
	if (func_307(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_307(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B1CD
{
	int num;

	if (!func_154(echParam1))
	{
		num = func_350(echParam1);
...
int func_350(eCharacter echParam0) // Position - 0x2BDE5
{
	if (!func_154(echParam0))
