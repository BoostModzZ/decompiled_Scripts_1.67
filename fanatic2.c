...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x2A9D9
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2B32E
{
	var unk;
	int num;
	int i;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x2D23F
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x308D2
{
...
void func_405(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x30E72
{
	...
	if (unk_0xFC8BFE4B41177C22(unk))
	{
		...
		if (unk_0xD9F5E1FEFD1329E4(unk, 0))
		{
			...
			if (bParam16)
				if (func_407(unk, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL func_407(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x31292
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_408(echParam1, i, &unk, &num); i = i + 1)
	{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x31E89
{
...
BOOL func_452(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x3383D
{
	if (func_453(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_453(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x33899
{
	int num;
...
int func_493(eCharacter echParam0) // Position - 0x34529
{
