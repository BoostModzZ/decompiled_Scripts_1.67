...
void func_1() // Position - 0xDF
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()) && func_171(CHAR_MICHAEL))
	{
		switch (iLocal_220)
		{
			case 0:
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1DF34
{
...
int func_142(eCharacter echParam0) // Position - 0x1DF59
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1E1EE
{
...
void func_163(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13) // Position - 0x1EBF7
{
	...
	if (character == echParam0)
	{
		...
		if (flag)
			func_164(unk_0x5C7E2225D7451992(&unk, &unk, 0, 2, unk_0xFACCDE46E24AD056(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam1)), 0));
		else
			func_164(unk_0x5C7E2225D7451992("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xFACCDE46E24AD056(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam1)), 0));
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x204A0
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_190() // Position - 0x205BE
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		{
			if (unk_0x4B423FAA24E8ABF0(unk[i]) == func_191(CHAR_MARNIE))
			{
				uLocal_51 = unk[i];
...
int func_191(eCharacter echParam0) // Position - 0x2066F
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x20D4B
{
	if (iParam2 == -1)
		iParam2 = func_78();
