...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x27AD
{
	if (iParam2 == -1)
		iParam2 = func_7();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x2FC1
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2FFE
{
...
int func_48(eCharacter echParam0) // Position - 0x3023
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xA6B8
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC902
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_226() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_130(8, -1) || func_221() || func_220() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
