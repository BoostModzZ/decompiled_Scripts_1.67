	...
	if (!unk_0x4FAFF4BCB7633475(uLocal_73) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && func_170(uLocal_75) && unk_0xE100DD4F82A51BDE(sLocal_304))
	{
		switch (iLocal_49)
		{
			...
			case 5:
				...
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_73) && func_170(uLocal_75))
					{
						unk_0xB5396F1FB088FE38(&uLocal_76);
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1A8B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1AC8
{
...
int func_17(eCharacter echParam0) // Position - 0x1AED
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x3271
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x3990
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x3DC1
{
	var unk;
	int num;
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x57BA
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9718
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_229() || Global_32286 || func_228() || func_61(8, -1) || func_225() || func_227() || func_226() || func_224() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_229() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_61(8, -1) || func_224() || func_223() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
