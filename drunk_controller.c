...
void func_2() // Position - 0xE3
{
	...
	if (Global_44536 > num || Global_44536 == -1)
	{
		...
		{
			num6 = Global_44540 - Global_44539;
			Global_44539 = Global_44539 + (num6 * 0.1f);
		
			if (unk_0x1D5CD3EAAA7422B0(Global_44539 - Global_44540) < 0.01f)
				Global_44539 = Global_44540;
		}
	
		if (!unk_0x7F2356076C3D052D() && !func_8(unk_0x259BE71D8A81D4FA()))
			unk_0xD5681045964A2975("DRUNK_SHAKE", Global_44539 * num3 * num5);
		...
		if (unk_0x1DD05E817C89C737() % 100 == 0)
		{
			...
			else
			{
				...
				unk_0xB3CAD109683148E3(Global_44539 * num3 * num5);
				unk_0x9B669C0440D2AB57(Global_44538 * num3 * num5);
				fLocal_26 = num3;
			}
		}
	
		if (Global_44538 * num3 * num5 < 1f)
			unk_0xC30B691CAD767629(Global_44538 * num3 * num5);
		else
			unk_0xC30B691CAD767629(1f);
	
		if (!unk_0x0E9A1CE27A31950D())
			unk_0xE31C735DEE2BF705("DRUNK_SHAKE", Global_44539 * Global_44533 * num3 * num5);
	
		unk_0xAD0E20104A60B568(Global_44539 * Global_44533 * num3 * num5);
	
		if (unk_0x78411E34CF90EA8C(Global_44535))
			if (unk_0xDD87838D03B64B0A(Global_44535))
				unk_0x17F06E9D89A05855(Global_44535, Global_44539 * num3 * num5);
	
		if (!unk_0xD6F9DEE4765092A9(&Global_44563) && !unk_0xD6F9DEE4765092A9(&Global_44547))
		{
			unk_0xCAC4020CCF361AC8(&Global_44547);
		...
		if (Global_44542 > 0f)
		{
			if (fLocal_16 != Global_44542)
			{
				...
				{
					unk_0xDA3EE68EF78AA786(&Global_44543, 15f);
					fLocal_16 = Global_44542;
				
					if (Global_44541 != 1f)
						unk_0x886C31F5E888F079(Global_44541);
				}
			}
			else
			{
				...
				num7 = Global_44536 - num;
			
				if (num7 <= Global_44537 / 2 && Global_44536 != -1)
				{
					flag = false;
					...
					else
					{
						if (unk_0x8960847E5FD7B48F() != -1)
							unk_0x20C160A285F3529C(SYSTEM::TO_FLOAT(Global_44537 / 2) / 1000f);
...
void func_16(int iParam0) // Position - 0x770
{
	...
	if (unk_0x1C2F771CDC87A3A5(Global_44329[iParam0 /*5*/].f_1, 0))
	{
		func_19(iParam0);
		return;
	}
