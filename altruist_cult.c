...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x2B66
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2BB2
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x76A4
{
	if (iParam2 == -1)
		iParam2 = func_27();
