			...
			if (_NETWORK_IS_PLAYER_VALID(player, bParam4, bParam5))
			{
				if (iParam10 || unk_0xDFAE61B1AEF262C2(unk_0x259BE71D8A81D4FA(), player))
				{
					if (!bParam7 || !unk_0x4FAFF4BCB7633475(unk_0x56E414973C2A8C0E(player)) && func_23(player))
					{
						...
						{
							if (unk_0x1864096A95E36EBA(unk_0x259BE71D8A81D4FA()) == -1 && bParam9 && bParam6 && func_33(player))
							{
							}
...
{
	if (func_38(unk_0x259BE71D8A81D4FA(), plParam0))
		return true;

	Global_2764376 = { func_37(plParam0) };

	if (unk_0xEDD63461767A518C(&Global_2764376))
		return true;

	if (func_34(unk_0x259BE71D8A81D4FA(), plParam0))
		return true;
...
struct<13> func_37(Player plParam0) // Position - 0x13FE
{
	var unk;
...
BOOL func_38(var uParam0, Player plParam1) // Position - 0x1415
{
	if (unk_0x7260716F2E4D7661())
	{
		Global_2764376 = { func_37(uParam0) };
		Global_2764389 = { func_37(plParam1) };
...
BOOL func_163(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8D53
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(num2, true, true) || func_24(num2, 0) || IS_BIT_SET(Global_2657704[num2 /*463*/].f_199, 2) || func_164(num2))
		{
		}
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0xB1E3
{
	if (iParam2 == -1)
		iParam2 = func_26();
...
void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x313B7
{
	int num;
...
void func_315(Player plParam0, int iParam1, int iParam2) // Position - 0x322F9
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		...
		num.f_2 = iParam1;
		num.f_4 = iParam2;
		num.f_5 = func_317(plParam0);
		func_316(&(num.f_6), &(num.f_7));
		unk_0x01F0B819E78A18A1(1, &num, 8, func_312(plParam0));
	}
...
int func_319(char* sParam0, Player plParam1, int iParam2, int iParam3, BOOL bParam4, int iParam5) // Position - 0x323A6
{
	int num;
	var unk;
	...
	if (unk_0xDFAE61B1AEF262C2(unk_0x259BE71D8A81D4FA(), plParam1) || iParam5)
	{
		...
		unk_0xCCDB0041859B85A6(sParam0);
		unk_0x4E5A3D96808F7F84(func_322(plParam1, -2, true, false, false));
...
int func_322(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3246C
{
	int num;
	var unk;
					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0x1C1C92A1CBAE364B(unk), false, true))
						if (iParam1 > -1 && unk_0x834C960822A4683F() && iParam1 < 4)
							if (Global_4718592.f_112316[iParam1] != -1)
								...
								return func_334(plParam0, unk_0x1C1C92A1CBAE364B(unk), iParam1, bParam2, bParam3);
						else
							return func_334(plParam0, unk_0x1C1C92A1CBAE364B(unk), iParam1, bParam2, bParam3);
	...
	if (iParam1 > -1 && unk_0x834C960822A4683F() && iParam1 < 4)
		if (Global_4718592.f_112316[iParam1] != -1)
			...
			return func_334(plParam0, unk_0x259BE71D8A81D4FA(), iParam1, bParam2, bParam3);
...
int func_334(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x32A1D
{
	int num;
	BOOL flag;
	Player player;
	...
	if (!flag)
	{
		if (num != -1)
		{
			...
			if (func_336(plParam1, plParam0, num, 0) && !IS_BIT_SET(Global_4718592.f_15, 18) || func_162(unk_0x1864096A95E36EBA(plParam1), unk_0x1864096A95E36EBA(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.f_15, 23) && !IS_BIT_SET(Global_4718592.f_15, 18))
				return func_328(true);
			else if (IS_BIT_SET(Global_4718592.f_15, 26))
				return func_335(true);
			else
				return func_324(plParam1, true, num, bParam4);
		}
...
int func_354(int iParam0, Player plParam1, BOOL bParam2) // Position - 0x32F5A
{
	int num;
	int num2;
	int num3;
	...
	if (iParam0 > -1 && plParam1 != _INVALID_PLAYER_INDEX())
	{
		...
		if (IS_BIT_SET(Global_4718592.f_15, 26) && !func_162(iParam0, unk_0x1864096A95E36EBA(plParam1), 0, -1))
			num = func_335(true);
	}
	else
	{
...
Player func_364() // Position - 0x33299
{
...
void func_377() // Position - 0x3358A
{
	if (_NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true))
	{
		...
		{
			if (!unk_0x4C705AAF75363287() && !func_382() && !func_381() && !func_380() && func_387(31, false, false) && !func_411(unk_0x259BE71D8A81D4FA()) && !_IS_FMMC_ACTIVE())
			{
				if (func_386(60000))
				{
					if (!func_187())
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x344A0
{
	switch (func_120())
	{
		case 0:
