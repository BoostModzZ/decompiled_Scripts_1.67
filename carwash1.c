...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1545
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_25(var uParam0) // Position - 0x1563
{
	...
	Global_2657704[player /*463*/].f_244 = 0;
	return;
}
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x1780
{
...
BOOL func_66(var uParam0) // Position - 0x632F
{
	...
	if (Global_78689)
	{
		...
		return Global_2657704[player /*463*/].f_244;
	}
...
void func_72(var uParam0, int iParam1) // Position - 0x6569
{
	...
	if (Global_78689)
	{
		...
		if (player != _INVALID_PLAYER_INDEX())
			if (Global_2657704[player /*463*/].f_244 == true)
				Global_2657704[player /*463*/].f_244 = 0;
	}
...
void func_81(var uParam0, int iParam1) // Position - 0x6778
{
	...
	Global_2657704[player /*463*/].f_244 = iParam1;
	return;
}
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xB25F
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB29C
{
...
int func_168(eCharacter echParam0) // Position - 0xB2C1
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(var message) // Position - 0x2C31C
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2D260
{
	var unk;
	int num;
	int i;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2D369
{
	switch (func_22())
	{
		case 0:
