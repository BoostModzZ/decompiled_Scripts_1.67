...
BOOL func_213(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDC0F
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_211(unk_0x4A8C381C258A124D(), uParam1, 1) < fParam9)
	{
		unk = 16;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDCD2
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFB4A
{
...
BOOL func_281(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x106E0
{
	if (func_282(uParam0, echParam1, uParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_282(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1073C
{
	int num;
...
BOOL func_286(var uParam0) // Position - 0x10876
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_281(&uParam0->f_28[0], CHAR_BARRY, unk6, num2, "RC LAUNCHER: BARRY 2", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
...
BOOL func_289(var uParam0) // Position - 0x10C55
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_281(&uParam0->f_28[0], CHAR_BARRY, unk8, num2, "RC LAUNCHER: BARRY 1", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
...
int func_324(eCharacter echParam0) // Position - 0x11A0A
{
	if (!func_36(echParam0))
