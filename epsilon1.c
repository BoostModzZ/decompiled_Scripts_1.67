...
eCharacter func_163(var uParam0) // Position - 0x1FFF0
{
	eCharacter i;
	int num;
...
void func_298(var uParam0, BOOL bParam1) // Position - 0x29B5E
{
	...
	if (func_166(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_299(uParam0, &Global_113810.f_2366.f_539.f_298[character /*477*/]);
			...
			for (i = 0; i <= 8 - 1; i = i + 1)
			{
				...
				if (bParam1)
				{
					...
					if (Global_113810.f_2366.f_539.f_1730[i /*4*/][character] == num)
...
void func_339(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2BFF7
{
	...
	if (func_166(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		func_340(uParam0, &Global_113810.f_2366.f_539.f_298[character /*477*/], bParam1);
	
		for (i = 0; i <= 8 - 1; i = i + 1)
		{
			unk_0xB0D3DD0BB37136FD(Global_113810.f_2366.f_539.f_1730[i /*4*/][character]);
			...
			if (bParam2)
				if (i == Global_113810.f_2366.f_539.f_1763 || Global_113810.f_2366.f_539.f_1763 == -1 && i == 4)
					if (Global_113810.f_2366.f_539.f_1730[i /*4*/][character] != 0 && Global_113810.f_2366.f_539.f_1730[i /*4*/][character] != joaat("WEAPON_MOLOTOV"))
						if (unk_0x66B90BA528CFEBCE(uParam0, Global_113810.f_2366.f_539.f_1730[i /*4*/][character], 0))
							unk_0x3C0F448853B71C92(uParam0, Global_113810.f_2366.f_539.f_1730[i /*4*/][character], 1);
		}
