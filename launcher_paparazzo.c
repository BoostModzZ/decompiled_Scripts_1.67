...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xACF6
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD803
{
...
BOOL func_257(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA51
{
...
BOOL func_258(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAAD
{
	int num;
...
int func_296(eCharacter echParam0) // Position - 0x11273
{
	if (!func_36(echParam0))
