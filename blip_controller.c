							...
							if (IS_BIT_SET(Global_32663[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_TREVOR:
										...
										{
											Global_32663[j /*23*/].f_19 = unk_0x34864AB7DA700AA6(Global_32663[j /*23*/][echLocal_62 /*3*/]);
											unk_0x4C905FB262965D5D(Global_32663[j /*23*/].f_19, Global_32663[j /*23*/].f_12[echLocal_62]);
										}
										break;
						...
						else
						{
							if (IS_BIT_SET(Global_32663[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_MICHAEL:
									case CHAR_TREVOR:
										unk_0xDABC73EF230B6665(Global_32663[j /*23*/].f_19, Global_32663[j /*23*/][echLocal_62 /*3*/]);
										break;
...
void func_20(var uParam0, int iParam1) // Position - 0xEA4
{
	...
	if (IS_BIT_SET(Global_32663[iParam1 /*23*/].f_11, 19))
	{
		switch (character)
		{
			...
			case CHAR_MICHAEL:
			case CHAR_TREVOR:
				unk_0xDABC73EF230B6665(Global_32663[iParam1 /*23*/].f_19, Global_32663[iParam1 /*23*/][character /*3*/]);
				break;
		}
	}
