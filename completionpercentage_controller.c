...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x2FED6B8DCEAE8D75() > Global_113810.f_10052)
		{
			...
			func_4(_GET_CURRENT_PLAYER_CHARACTER(), 4, (unk_0x2FED6B8DCEAE8D75() - Global_113810.f_10052) * 2);
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xD99
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xDD6
{
...
int func_15(eCharacter echParam0) // Position - 0xDFB
{
