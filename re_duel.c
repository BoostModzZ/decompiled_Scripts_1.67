	...
	switch (iLocal_46)
	{
		...
		case 1:
			switch (iLocal_153)
			{
				...
				case 3:
					if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) || unk_0xC450B06E5AAA0985(uLocal_47[0 /*5*/].f_1) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]) || unk_0xC450B06E5AAA0985(uLocal_47[1 /*5*/].f_1))
						iLocal_153 = iLocal_153 + 1;
					break;
				...
				case 9:
					if (func_97() || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]) && func_82(unk_0x4A8C381C258A124D(), uLocal_88[0 /*4*/], 1) <= 35f)
					{
								...
								if (!unk_0x7B780C491DEC834E(unk6, 7f) && !unk_0x7B780C491DEC834E(unk9, 7f) && !unk_0x7B780C491DEC834E(unk12, 7f) && !func_79(unk9, 1084227584) && !func_79(unk12, 1084227584))
								{
									...
									for (i = 2; i <= 7; i = i + 1)
									{
										if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[i /*5*/]))
										{
											...
											{
												if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_47[i /*5*/], 0) == -1)
												{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x87E4
{
	var unk;
	int num;
	int i;
...
BOOL func_89() // Position - 0x94CF
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) && func_82(unk_0x4A8C381C258A124D(), uLocal_47[0 /*5*/], 1) >= 200f && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]) && func_82(unk_0x4A8C381C258A124D(), uLocal_47[1 /*5*/], 1) >= 200f)
		return true;

	if (func_156(10) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) || func_156(11) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) && unk_0x1B32E388988DD296(uLocal_47[0 /*5*/], unk_0x4A8C381C258A124D()) || !unk_0x7F420695E3F776FB(uLocal_47[0 /*5*/], 0) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]) && unk_0x1B32E388988DD296(uLocal_47[1 /*5*/], unk_0x4A8C381C258A124D()) || !unk_0x7F420695E3F776FB(uLocal_47[1 /*5*/], 0))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[1 /*4*/]) && unk_0x9B3D4335E0EDB0BE(uLocal_88[1 /*4*/], unk_0x4A8C381C258A124D(), 1) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[2 /*4*/]) && unk_0x9B3D4335E0EDB0BE(uLocal_88[2 /*4*/], unk_0x4A8C381C258A124D(), 1))
		return true;
	...
	if (unk_0x74408742BCE2802F(unk_0x4A8C381C258A124D()))
	{
		...
		if (unk == uLocal_88[3 /*4*/] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) || unk == uLocal_88[4 /*4*/] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]))
			return true;
	}
...
int func_90(int iParam0) // Position - 0x9697
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num) && fLocal_162 != 0f && fLocal_162 >= 9f)
	{
...
{
	return _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]) && unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_88[0 /*4*/], 0);
}
...
void func_125() // Position - 0xABB8
{
	...
	if (func_156(5) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iLocal_171 /*4*/]) && unk_0x1DD05E817C89C737() < iLocal_155)
	...
	if (func_156(9) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]) && func_82(unk_0x4A8C381C258A124D(), uLocal_88[0 /*4*/], 1) <= 35f)
	{
		if (!func_156(10))
		{
...
void func_132(int iParam0) // Position - 0xB0F0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iParam0 /*4*/]))
	{
		...
		{
			case 5:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[2 /*5*/]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[3 /*5*/]) || !unk_0xD9F5E1FEFD1329E4(uLocal_88[iParam0 /*4*/], 0))
					func_133(iParam0, false);
				break;
		
			case 6:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[4 /*5*/]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[5 /*5*/]) || !unk_0xD9F5E1FEFD1329E4(uLocal_88[iParam0 /*4*/], 0))
					func_133(iParam0, false);
				break;
		
			case 7:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[6 /*5*/]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[7 /*5*/]) || !unk_0xD9F5E1FEFD1329E4(uLocal_88[iParam0 /*4*/], 0))
					func_133(iParam0, false);
				break;
		
			case 3:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*5*/]) || !unk_0xD9F5E1FEFD1329E4(uLocal_88[iParam0 /*4*/], 0))
			...
			case 4:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*5*/]) || !unk_0xD9F5E1FEFD1329E4(uLocal_88[iParam0 /*4*/], 0))
					if (func_82(unk_0x4A8C381C258A124D(), uLocal_88[iParam0 /*4*/], 1) >= 50f)
						func_133(iParam0, false);
			...
			case 1:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[3 /*4*/]) || func_82(uLocal_88[3 /*4*/], uLocal_88[iParam0 /*4*/], 1) >= 150f)
					func_133(iParam0, false);
				break;
		
			case 2:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[4 /*4*/]) || func_82(uLocal_88[4 /*4*/], uLocal_88[iParam0 /*4*/], 1) >= 150f)
					func_133(iParam0, false);
				break;
				...
				switch (uLocal_47[iParam0 /*5*/].f_3)
				{
					...
					case 1:
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num /*4*/]))
						{
							...
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]) && !unk_0x685171EED42BC4DF(uLocal_88[num /*4*/], uLocal_88[0 /*4*/]))
							{
								...
								if (unk_0x1DD05E817C89C737() >= iLocal_159 && unk_0xF6C26AE940C14749(uLocal_88[num /*4*/]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num2 /*4*/]) && func_82(uLocal_88[num /*4*/], uLocal_88[num2 /*4*/], 1) >= 20f)
								{
								...
								if (func_130(iParam0, 3) || func_82(uLocal_47[iParam0 /*5*/], unk_0x4A8C381C258A124D(), 1) <= 15f || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num2 /*4*/]) && func_82(uLocal_88[num /*4*/], uLocal_88[num2 /*4*/], 1) <= 15f)
								{
									if (func_82(uLocal_47[iParam0 /*5*/], unk_0x4A8C381C258A124D(), 1) <= 15f)
									{
...
void func_138(int iParam0, BOOL bParam1) // Position - 0xBA60
{
	if (unk_0xFC8BFE4B41177C22(uLocal_47[iParam0 /*5*/]))
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam0 /*5*/]) && unk_0xA3736D76B0E93E93(uLocal_47[iParam0 /*5*/]) && !unk_0x7F420695E3F776FB(uLocal_47[iParam0 /*5*/], 1) && !unk_0x27E68848F0E5D7D9(uLocal_47[iParam0 /*5*/]) && !unk_0x9D6DF8F3584AAC2B(uLocal_47[iParam0 /*5*/]))
...
void func_140() // Position - 0xBB26
{
	if (func_156(1) || iLocal_153 > 2 && func_141())
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]) && func_82(unk_0x4A8C381C258A124D(), uLocal_88[0 /*4*/], 1) >= 250f)
			func_64();

	if (func_141())
		if (unk_0xFC8BFE4B41177C22(uLocal_88[0 /*4*/]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0 /*4*/]))
			func_64();
...
BOOL func_141() // Position - 0xBB98
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[i /*5*/]) && unk_0xC450B06E5AAA0985(uLocal_47[i /*5*/].f_1))
		{
			num = 0;
			i = 8;
		}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_194() || Global_32286 || func_193() || func_192(8, -1) || func_189() || func_191() || func_190() || func_188() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_194() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_192(8, -1) || func_188() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xF9C4
{
