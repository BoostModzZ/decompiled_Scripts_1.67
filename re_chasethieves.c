...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x2587
{
	if (iParam2 == -1)
		iParam2 = func_51();
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x333A
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x35CE
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x22B8A
{
...
void func_251() // Position - 0x22E11
{
	...
	else
	{
		...
		else
		{
			...
			if (iLocal_71 == 0 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90) && func_256(unk_0x4A8C381C258A124D(), uLocal_90, 1) < 30f && _CONVERSATION_ADD_LINE(&uLocal_246, "RECHAAU", "RECHA_SPOT", 4, 0, 0, 0))
				iLocal_71 = 1;
		}
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x24975
{
	var unk;
	int num;
	int i;
...
void func_305() // Position - 0x253C1
{
	...
	else
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_85))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _CONVERSATION_ADD_LINE(&uLocal_246, "RECHAAU", "RECHA_STO", 4, 0, 0, 0) || func_256(unk_0x4A8C381C258A124D(), uLocal_85, 1) < 20f)
			{
				unk_0xB5396F1FB088FE38(&uLocal_184);
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_393() || Global_32286 || func_392() || func_25(8, -1) || func_389() || func_391() || func_390() || func_388() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_393() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_25(8, -1) || func_388() || func_387() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
