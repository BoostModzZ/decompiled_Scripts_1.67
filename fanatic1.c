...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2E3F9
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0x336BF
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
			return true;
...
BOOL func_450(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x3397C
{
...
BOOL func_451(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x339D8
{
	int num;
...
int func_493(eCharacter echParam0) // Position - 0x34792
{
	if (!func_3(echParam0))
