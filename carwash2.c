...
void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F80
{
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xB26F
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB2AC
{
...
int func_169(eCharacter echParam0) // Position - 0xB2D1
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2C443
{
	var unk;
	int num;
	int i;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(var message) // Position - 0x2C684
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2D5EB
{
	switch (func_22())
	{
		case 0:
