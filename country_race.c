...
{
	if (!unk_0xFC8BFE4B41177C22(uParam0) || !unk_0xD9F5E1FEFD1329E4(uParam0, 0) || func_92(uParam0, CHAR_MICHAEL, false) || func_92(uParam0, CHAR_FRANKLIN, false) || func_92(uParam0, CHAR_TREVOR, false) || func_91(uParam0) != _CHAR_NULL || func_90(uParam0) || func_89(uParam0) || func_88(uParam0) || func_87(uParam0) || !func_74(unk_0x4B423FAA24E8ABF0(uParam0)))
	{
		func_89(uParam0);
		func_89(uParam0);
		func_92(uParam0, CHAR_MICHAEL, false);
		func_92(uParam0, CHAR_FRANKLIN, false);
		func_92(uParam0, CHAR_TREVOR, false);
		func_91(uParam0) != _CHAR_NULL;
		return false;
	}
...
eCharacter func_91(var uParam0) // Position - 0xD115
{
	int i;
...
BOOL func_92(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xD178
{
	int i;
	var unk;
	int num;
...
void func_167(var uParam0, var uParam1, int iParam2) // Position - 0x117C4
{
	...
	uParam0->f_7 = func_169(uParam1, _CHAR_NULL, 0);
...
int func_169(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x118E2
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98144[i]))
			if (Global_98144[i] == uParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98154[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(uParam0) == func_170(echParam1, iParam2))
						return 1;
	}
...
int func_170(eCharacter echParam0, int iParam1) // Position - 0x11970
{
	int num;
...
void func_179(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x11F88
{
	eCharacter character;
...
void func_180(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x124D1
{
	eCharacter character;
...
void func_182(var uParam0, BOOL bParam1) // Position - 0x1272B
{
	...
	if (func_49(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_183(uParam0, &Global_113810.f_2366.f_539.f_298[character /*477*/]);
