...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x3220
{
	if (iParam2 == -1)
		iParam2 = func_58();
...
eCharacter func_130(int iParam0) // Position - 0x593E
{
	eCharacter i;
	int num;
	eCharacter character;
