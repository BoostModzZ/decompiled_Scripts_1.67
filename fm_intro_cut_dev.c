...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x558E
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x55CB
{
...
int func_61(eCharacter echParam0) // Position - 0x55F0
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x5C14
{
...
void _SET_TRANSITION_STATE(eTransitionState etsParam0) // Position - 0xCF80
{
	...
	if (Global_1575063)
	{
		...
		unk3 = _STOPWATCH_GET_TIME_PASSED(&Global_2697014, true, false);
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xD80F
{
...
var _STOPWATCH_GET_TIME_PASSED(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xD8F9
{
	if (unk_0x76CD105BCAC6EB9F() && !useLocalTimer)
		if (!useAccurateTime)
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0xE067
{
	eSetPlayerControlFlags controlBs;
	BOOL flag;
	BOOL flag2;
