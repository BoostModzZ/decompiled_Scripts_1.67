...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1EDBA
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1EDF7
{
...
int func_136(eCharacter echParam0) // Position - 0x1EE1C
{
