...
void func_2() // Position - 0xD7
{
	...
	if (!flag)
	{
		if (unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) || !unk_0x76CD105BCAC6EB9F() && !func_75(echLocal_57) || unk_0x3555462DB47B7AB1() || func_74() || unk_0xFD216000DC314A92() || unk_0x15CCE8886267624F() || !unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()) || Global_78687 || Global_98097 || bLocal_60)
		{
			bLocal_81 = true;
	...
	if (!unk_0x76CD105BCAC6EB9F() && unk_0x1DD05E817C89C737() - iLocal_55 > 2000 || unk_0x76CD105BCAC6EB9F() && unk_0xDBA141080166EAA2(unk_0x7E3F74F641EE6B27(), unk_0xAD5B43C219C4CB92(uLocal_56, 2000)) || bLocal_58)
	{
		...
		for (j = 0; j < num6; j = j + 1)
		{
			...
			func_73(echLocal_57, num5, &unk, &num4);
		
			if (unk_0x76CD105BCAC6EB9F())
				num = func_72(num4, -1);
			else if (num5 == 0)
				num = Global_113810.f_2366.f_539.f_2387[echLocal_57];
			else
			...
			if (func_58(echLocal_57, num5, num, &num2))
			{
				if (unk_0x76CD105BCAC6EB9F())
				{
					func_56(num4, num2, -1, 1);
				}
				else if (num5 == 0)
				{
					...
					Global_113810.f_2366.f_539.f_2387[echLocal_57] = num2;
				}
				else
				{
				...
				if (num2 > func_54(echLocal_57, num5, -1))
				{
					if (unk_0x76CD105BCAC6EB9F())
					...
					num7 = num2;
					num8 = num7 - (num7 % func_52(echLocal_57, num5));
				
					if (num7 % func_52(echLocal_57, num5) >= 0)
						num8 = num8 + func_52(echLocal_57, num5);
				
					if (num7 >= num8)
						num7 = num8;
					else
						num7 = num8 - func_52(echLocal_57, num5);
					...
					if (flag2)
					{
						if (!bLocal_58)
						{
							...
							bLocal_60 = true;
							iLocal_63 = num2 - num;
							iLocal_63 = iLocal_63 + (num % func_52(echLocal_57, num5));
							iLocal_64 = num2;
...
BOOL _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xC53
{
	int num;
...
int func_59(eCharacter echParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x17A1
{
	...
	switch (iParam1)
	{
		...
		case 1:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (num - Global_113810.f_2366.f_539.f_2355[echParam0]) / 175f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 2:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = SYSTEM::TO_FLOAT(value2 - Global_113810.f_2366.f_539.f_2359[echParam0]) / 20f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 4:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + (SYSTEM::TO_FLOAT(value2 - Global_113810.f_2366.f_539.f_2363[echParam0]) / 50f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 7:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (num - Global_113810.f_2366.f_539.f_2367[echParam0]) / 45f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
			...
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + ((SYSTEM::TO_FLOAT(value2 - Global_113810.f_2366.f_539.f_2371[echParam0]) / 2f) * 1.5f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 6:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value3 = value3 - num4;
				value = SYSTEM::TO_FLOAT(num4 - Global_113810.f_2366.f_539.f_2375[echParam0]) / 40f;
				value = value + (SYSTEM::TO_FLOAT(value3 - Global_113810.f_2366.f_539.f_2379[echParam0]) / 80f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
	...
	if (iParam1 != 0)
	{
		num8 = func_54(echParam0, iParam1, iParam3);
	...
	if (bParam2)
	{
		num9 = value - (value % (float)func_52(echParam0, iParam1));
	
		if (value % (float)func_52(echParam0, iParam1) >= 0f)
			num9 = num9 + (float)func_52(echParam0, iParam1);
	
		if (value >= num9)
			value = num9;
		else
			value = num9 - (float)func_52(echParam0, iParam1);
	}
...
Player func_68() // Position - 0x272F
{
	...
	if (!bLocal_79)
	{
		...
		else
		{
			...
			if (Global_113810.f_2366.f_539.f_2280[echLocal_57] == 0)
				Global_113810.f_2366.f_539.f_2280[echLocal_57] = unk_0x39D1D336459711BE();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x356C
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x35A9
{
...
int func_91(eCharacter echParam0) // Position - 0x35CE
{
