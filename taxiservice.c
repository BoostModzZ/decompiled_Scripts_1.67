...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1281
{
	if (iParam2 == -1)
		iParam2 = func_19();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x2D66
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2DA3
{
...
int func_61(eCharacter echParam0) // Position - 0x2DC8
{
