...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xB264
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB2A1
{
...
int func_65(eCharacter echParam0) // Position - 0xB2C6
{
...
int _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xCA6B
{
	if (unk_0x761778199FE1211C())
...
int func_175(eCharacter echParam0) // Position - 0x13089
{
