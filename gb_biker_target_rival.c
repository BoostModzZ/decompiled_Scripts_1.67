...
void func_3(Player plParam0) // Position - 0x145
{
	...
	player = plParam0;
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_388), player);
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_389), player);
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_390), player);
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_392), player);
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_396), player);
	unk_0x8744D2E3FC95740E(&(Global_2646835.f_391), player);
	return;
}
...
void func_14(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x3A9
{
	...
	if (bParam1)
	{
		...
		else if (unk_0xC450B06E5AAA0985(Global_2646835[player]))
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_2646835.f_370), player);
			unk_0x8744D2E3FC95740E(&(Global_2646835.f_375), player);
			unk_0x861AC9C2D48CEA7F(Global_2646835[player], 1);
			unk_0xB562F84CE9B07D89(Global_2646835[player], 250);
			func_15(plParam0);
		
			if (iParam2 < 0)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_2646835.f_375), player);
			else
				Global_2646835.f_201[player] = unk_0xAD5B43C219C4CB92(unk_0x7E3F74F641EE6B27(), iParam2);
		}
		else
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_2646835.f_370), player);
	...
	if (!bParam1)
	{
		unk_0x8744D2E3FC95740E(&(Global_2646835.f_370), player);
		unk_0x8744D2E3FC95740E(&(Global_2646835.f_375), player);
	
		if (unk_0xC450B06E5AAA0985(Global_2646835[player]))
		{
			func_15(plParam0);
			unk_0x861AC9C2D48CEA7F(Global_2646835[player], 0);
		}
	}
...
void func_15(Player plParam0) // Position - 0x4DE
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		if (unk_0xC450B06E5AAA0985(Global_2646835[player]))
		{
			...
			unk_0x1456FD5C0C438B19(Global_2646835[player], Global_2646835.f_1504[player]);
		}
	}
...
int func_16(Player plParam0) // Position - 0x52C
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		if (unk_0xC450B06E5AAA0985(Global_2646835[player]))
		{
			num = unk_0x8FACE824AEC046E8(Global_2646835[player]);
			...
			else
			{
				switch (num)
				{
					...
					case 254:
						if (unk_0x1864096A95E36EBA(plParam0) == unk_0x1864096A95E36EBA(Global_2672524))
							return func_70(6);
						else
							return func_70(5);
						break;
...
Player func_46(int iParam0) // Position - 0x1B3E
{
	if (func_11(iParam0))
...
BOOL func_74(var uParam0, var uParam1, var uParam2, BOOL bParam3, Player plParam4, BOOL bParam5, var uParam6) // Position - 0x2205
{
	if (bParam5)
	{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x22ED
{
	switch (func_78())
	{
		case 0:
...
{
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_2646835.f_368), plParam0);
	else
		unk_0x8744D2E3FC95740E(&(Global_2646835.f_368), plParam0);

	if (unk_0xC450B06E5AAA0985(Global_2646835[plParam0]))
		if (bParam1)
			unk_0x360B279488A775FC(Global_2646835[plParam0], 0);
		else
			unk_0x360B279488A775FC(Global_2646835[plParam0], 1);
