...
BOOL func_275(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x243BC
{
...
BOOL func_276(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x24418
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x24E98
{
	if (iParam2 == -1)
		iParam2 = func_113();
...
int func_380(eCharacter echParam0) // Position - 0x2B8FB
{
