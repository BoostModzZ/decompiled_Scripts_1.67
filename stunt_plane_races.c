...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x76D6
{
	var unk;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x87C1
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x87FE
{
...
int func_184(eCharacter echParam0) // Position - 0x8823
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x9BB8
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0xA6E9
{
	var unk;
	int num;
	int i;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xAD4A
{
					...
					if (unk99.f_3 > 0)
					{
						...
						for (k = num3; k <= unk99.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk.f_96 > 1)
							{
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_515(&unk, &(Global_2097536[num4 /*901*/][0 /*75*/].f_32)))
									{
										if (func_515(&unk, &unk107))
					...
					if (uParam0->f_5 && unk_0xF685596DB2F81084(&unk99))
					{
						...
						for (j = num3; j <= unk99.f_3 - 1; j = j + 1)
						{
							...
							if (Global_2097536.f_2704[num5] < 11 && unk.f_96 > 1)
							{
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_515(&unk, &(Global_2097536[num5 /*901*/][0 /*75*/].f_32)))
									{
										if (func_515(&unk, &unk107))
					...
					if (unk112.f_3 > 0)
					{
						...
						for (k = num3; k <= unk112.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk14.f_96 > 1)
							{
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk14) && !func_515(&(Global_2097536[num4 /*901*/][0 /*75*/].f_32), &unk14))
									{
										if (func_515(&unk14, &unk))
											if (Global_2097536.f_2775[num4] < 0)
												Global_2097536.f_2775[num4] = Global_2097536.f_2704[num4];
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x21AD7
{
