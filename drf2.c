...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x25EB
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2628
{
...
int func_44(eCharacter echParam0) // Position - 0x264D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2709
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3323
{
...
void func_224(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x1D68C
{
	eCharacter character;
...
void func_225(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x1DBD5
{
	eCharacter character;
