...
void func_4(int iParam0, BOOL bParam1) // Position - 0x25C
{
	...
	while (flag)
	{
		...
		if (num == Global_97904 && num2 == Global_97903)
			flag = false;
	}
...
void func_8() // Position - 0x475
{
	...
	if (!Global_97899)
	{
		Global_98083 = unk_0x8825A6E0A30BDCB8();
		Global_98082 = unk_0xB12880C92EA6EE15();
		Global_98081 = unk_0x5295501D0862870D();
		Global_97899 = true;
		Global_97904 = unk_0xDDA4278694CAA369();
		Global_97903 = unk_0x5295501D0862870D();
		func_12();
		return;
	}
	...
	if (num10 > 0)
	{
		...
		if (num10 > 7)
		{
			...
			for (i = 0; i < 7; i = i + 1)
			{
				for (j = 0; j < 24; j = j + 1)
				{
					if (!(Global_97905[num7 /*25*/][num8] == 0))
					{
						Global_97900 = Global_97900 + 1;
						Global_97902 = Global_97902 - 1;
					}
				
					Global_97905[num7 /*25*/][num8] = 0;
				}
			}
		}
		else if (num10 > 1)
