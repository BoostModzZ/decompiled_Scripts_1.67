...
void func_7() // Position - 0x1FB
{
	...
	if (IS_BIT_SET(Global_4542302, 23))
	{
		...
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542583));
		unk_0x330108B080A2132F(Global_4542304);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542583.f_1));
		unk_0x330108B080A2132F(Global_4542305);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542583.f_2));
		func_8("CELL_BODYG" /*Guard*/);
		unk_0x330108B080A2132F(Global_4542306);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542586));
		unk_0x330108B080A2132F(Global_4542307);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542586.f_1));
		unk_0x330108B080A2132F(Global_4542308);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4542586.f_2));
	}
	else
	{
		unk_0x557F1E2300EF1A3E(0);
