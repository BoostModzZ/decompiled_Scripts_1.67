			...
			default:
				if (num2 != -1)
				{
					...
					else if (Global_4535172[num2 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if (func_23(Global_4536680) && _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() && func_32(unk.f_2))
						{
							if (!func_22(Global_4535172[num2 /*85*/].f_66))
							{
								num5 = func_21();
...
BOOL _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x454D
{
	int num;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x4817
{
	switch (func_45())
	{
		case 0:
