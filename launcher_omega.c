...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xACBB
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_193() || Global_32286 || func_192() || func_191(8, -1) || func_189() || func_100() || func_190() || func_188() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_193() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_191(8, -1) || func_188() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_194(var uParam0) // Position - 0xCDFD
{
	...
	if (unk_0x1DD05E817C89C737() - uLocal_96 > 1250)
	{
		...
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && !func_195(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 50f, 1))
			{
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCFFA
{
	...
	if (!(*uParam8 == 3))
	{
		if (func_185(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_204(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1FE
{
...
BOOL func_257(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF32A
{
...
BOOL func_258(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF386
{
	int num;
...
int func_297(eCharacter echParam0) // Position - 0x100D8
{
	if (!func_36(echParam0))
