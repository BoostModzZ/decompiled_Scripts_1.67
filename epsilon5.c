...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1FA1E
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FA5B
{
...
int func_152(eCharacter echParam0) // Position - 0x1FA80
{
...
void func_206(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x27042
{
	eCharacter character;
	BOOL flag;
	var unk;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x286B8
{
...
BOOL func_241(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x28B54
{
	int i;
	var unk;
	int num;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2911F
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x29E75
{
...
BOOL func_309(var uParam0) // Position - 0x2AE9E
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_310(&uParam0->f_28[0], CHAR_MARNIE, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_220(unk_0x4A8C381C258A124D()))
				{
...
BOOL func_310(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B021
{
	if (func_311(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_311(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B07D
{
	int num;

	if (!func_153(echParam1))
	{
		num = func_355(echParam1);
...
int func_355(eCharacter echParam0) // Position - 0x2BCD8
{
