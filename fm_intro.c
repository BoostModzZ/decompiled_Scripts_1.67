	...
	if (IS_BIT_SET(iLocal_718, 18))
	{
		if (!IS_BIT_SET(iLocal_718, 2))
		{
			if (unk_0x9390801B06EE998F())
			{
				...
				if (func_101(&uLocal_370, CHAR_LAMAR, "FM_1AU", "FM_ICALL", num, 0))
				{
					func_100(true);
...
void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B7E
{
	int num;
...
struct<13> func_80(Player plParam0) // Position - 0x2F0C
{
	var unk;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x3464
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x34A1
{
...
int func_98(eCharacter echParam0) // Position - 0x34C6
{
...
BOOL func_102(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, BOOL bParam8, int iParam9, char* sParam10, char* sParam11, Player plParam12) // Position - 0x354A
{
	var unk;
	var unk2;
	int num;
...
BOOL func_109(var uParam0, eCharacter echParam1, Player plParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, BOOL bParam9, int iParam10, char* sParam11, char* sParam12) // Position - 0x3735
{
	var unk;
...
BOOL func_110(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x382E
{
	BOOL flag;
...
BOOL func_112(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x3888
{
	Player player;
	int num;
	char* str;
	...
	num2 = 0;
	str2 = func_136(sParam5, bParam6, &num2);
	...
	if (!(num2 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_133(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
...
int func_117(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3A74
{
	...
	func_118(echParam0, sParam1, num2, func_122(unk_0x259BE71D8A81D4FA()));
	return 1;
}
...
BOOL func_133(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x49C6
{
	int num;
...
BOOL func_145(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4DA5
{
	BOOL flag;
...
BOOL func_146(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4DCC
{
	BOOL flag;
...
BOOL func_147(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x4DEF
{
	Player player;
	int num;
	char* str;
	...
	if (!(num2 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_156(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
...
int func_150(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x4FDC
{
	...
	func_151(echParam0, sParam1, num2, func_122(unk_0x259BE71D8A81D4FA()));
	return 1;
}
...
BOOL func_156(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x58FD
{
	int num;
...
BOOL func_157(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x59A9
{
	BOOL flag;
...
void _SET_TRANSITION_STATE(eTransitionState etsParam0) // Position - 0x12C22
{
	...
	if (Global_1575063)
	{
		...
		unk2 = _STOPWATCH_GET_TIME_PASSED(&Global_2697014, true, false);
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x134B1
{
...
var _STOPWATCH_GET_TIME_PASSED(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1359B
{
	if (unk_0x76CD105BCAC6EB9F() && !useLocalTimer)
		if (!useAccurateTime)
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x13CB7
{
	eSetPlayerControlFlags controlBs;
	BOOL flag;
	BOOL flag2;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x16A09
{
...
void func_429(BOOL bParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x16DBA
{
	...
	if (unk_0x76CD105BCAC6EB9F())
	{
		switch (Global_1927408.f_9)
		{
			...
			case 2:
				...
				player = Global_1853988[num /*867*/].f_10;
			
				if (player != _INVALID_PLAYER_INDEX())
					if (unk_0x762604C40829DB72(player))
						Global_2684820.f_6023 = { func_80(player) };
					else
						flag3 = true;
				else
					flag3 = true;
	...
	if (Global_1853988[num /*867*/] != -1)
	{
		...
		if (func_557(Global_1853988[num /*867*/]))
		{
			if (unk_0x261E3728EE56B3AC())
			{
				num4 = func_529(0);
				func_528(1213, -1);
				func_525(joaat("MPPLY_MGAME_CHEAT_END"), num4);
	...
	if (func_476(116, &num5))
		func_475(num5);

	if (func_476(123, &num5))
		func_475(num5);
...
int func_593() // Position - 0x1A1A6
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (unk_0x762604C40829DB72(player) && player != player2)
		{
			...
			if (unk_0xD43ED7463CB7671C(&unk, &(Global_2684820.f_6641)) && func_595(player))
			{
				func_594();
				return 1;
			}
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1AF2B
{
	if (iParam2 == -1)
		iParam2 = func_30();
...
void func_759() // Position - 0x1C3C8
{
	...
	if (unk_0x76CD105BCAC6EB9F() && _STOPWATCH_IS_INITIALIZED(&Global_2803710))
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2803710, 3500, true) || unk_0xCF580EB76CEC15FD(unk_0x259BE71D8A81D4FA()))
		{
			if (!func_761())
			{
				if (unk_0x15CCE8886267624F())
...
void func_760(int iParam0) // Position - 0x1C4EB
{
	...
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2803715[iParam0 /*2*/], 3500, true) || unk_0xCF580EB76CEC15FD(iParam0))
		{
			if (!func_761())
			{
				if (unk_0x15CCE8886267624F())
				{
					_STOPWATCH_RESET(&Global_2803715[iParam0 /*2*/], true, false);
				}
		...
		else
		{
			...
			_STOPWATCH_DESTROY(&Global_2803715[iParam0 /*2*/]);
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1E328
{
	switch (func_19())
	{
		case 0:
