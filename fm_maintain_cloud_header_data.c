...
struct<13> func_56(Player plParam0) // Position - 0x19AC
{
	var unk;
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x1E18
{
	...
	if (_IS_NULL_VECTOR(Global_997115.f_33[num2 /*88*/].f_56))
		unk_0x8744D2E3FC95740E(&(Global_997115.f_33[num2 /*88*/].f_76), 13);
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x21082
{
	if (iParam2 == -1)
		iParam2 = func_17();
