...
void func_112(var uParam0, BOOL bParam1) // Position - 0x6613
{
	...
	if (func_90(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_113(uParam0, &Global_113810.f_2366.f_539.f_298[character /*477*/]);
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_165() || Global_32286 || func_171() || func_170(8, -1) || func_163() || func_152() || func_169() || func_164() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_165() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_170(8, -1) || func_164() || func_168() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC7E6
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0xD8CD
{
	if (iParam2 == -1)
		iParam2 = func_105();
...
int func_231(eCharacter echParam0) // Position - 0xE3DD
{
	if (!func_90(echParam0))
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x10314
{
