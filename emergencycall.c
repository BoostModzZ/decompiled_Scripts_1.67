		...
		if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		{
			switch (iLocal_41)
			{
				...
				case 4:
					...
					{
						if (Global_97310.f_358 == unk_0x70E57E9927B6BA58("AGENCY_PREP_1") || unk_0x486FF5D06E9659F1(unk_0x70E57E9927B6BA58("agency_prep1")) > 0 && _IS_MISSION_REPEAT_ACTIVE(false))
