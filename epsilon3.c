...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x29004
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x29B2B
{
...
BOOL func_266(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x29FC6
{
	int i;
	var unk;
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B070
{
...
BOOL func_321(var uParam0) // Position - 0x2BECA
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_322(&uParam0->f_28[0], CHAR_MARNIE, unk2, num2, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
...
BOOL func_322(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2C090
{
	if (func_323(uParam0, echParam1, uParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_323(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2C0EC
{
	int num;

	if (!func_16(echParam1))
	{
		num = func_370(echParam1);
...
int func_370(eCharacter echParam0) // Position - 0x2CDDD
{
