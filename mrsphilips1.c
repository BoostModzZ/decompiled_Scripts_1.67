...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0xA69
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1F9C9
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FA06
{
...
int func_153(eCharacter echParam0) // Position - 0x1FA2B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x26DC7
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x273B9
{
