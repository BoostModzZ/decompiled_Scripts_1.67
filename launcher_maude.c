...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC44
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_243(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xED63
{
	if (func_244(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_244(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEDBF
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_249(echParam1);
...
int func_249(eCharacter echParam0) // Position - 0xEFEB
{
	if (!func_36(echParam0))
