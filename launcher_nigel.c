...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADDE
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_197() || Global_32286 || func_196() || func_195(8, -1) || func_193() || func_100() || func_194() || func_192() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_197() || Global_112857 || Global_32286 || func_196() || func_195(8, -1) || func_100() || func_194() || func_192() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_197() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_195(8, -1) || func_192() || func_191() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
int func_203(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD982
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_207(unk_0x4A8C381C258A124D(), fParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDA9B
{
...
int func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xDB70
{
	...
	if (!(*uParam10 == 3))
	{
		if (func_189(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_207(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			else if (func_210(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && func_207(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
			{
...
BOOL func_265(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFE68
{
	if (func_266(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_266(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFEC4
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_329(echParam1);
...
int func_329(eCharacter echParam0) // Position - 0x16050
{
	if (!func_36(echParam0))
