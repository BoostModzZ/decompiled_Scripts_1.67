...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9D0B
{
...
void func_153(var uParam0, var uParam1) // Position - 0x9F55
{
	if (!func_157(uParam0, false, true))
	{
		if (func_150(uParam1))
		{
			if (unk_0x875A214D5EBCA509(0, 86) || unk_0x4465D55576678706(0, 86))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0x4C705AAF75363287() && !func_121(0) && !func_60(6) && !func_60(7) && !(unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0) && _GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_FRANKLIN)
				{
