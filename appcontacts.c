...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x6CA8
{
			...
			while (character < character2)
			{
				...
				if (character3 != CHAR_ACTING_UP)
				{
					...
					if (unk_0x1B79E937E91F40C3(unk, &uLocal_83))
						if (func_144(character3, Global_20500) == 1 || func_144(character3, Global_20500) == 2 || unk_0x1B79E937E91F40C3(unk, unk_0xFACCDE46E24AD056(&(Global_117[130 /*10*/].f_4))))
					...
					if (iLocal_87 > 6)
					{
						...
						if (iLocal_280 == 0)
						{
							if (iLocal_87 == 10 || iLocal_87 == 7)
							{
								...
								{
									num4 = func_143(&uLocal_291[5]);
									num5 = func_143(&uLocal_291[6]);
									func_142(num4, num5);
									iLocal_280 = 1;
								}
							}
...
struct<13> func_182(Player plParam0) // Position - 0xC625
{
	var unk;
...
int func_190(char* sParam0, Player plParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD2D9
{
	int num;
	int num2;
	var unk;
		...
		if (func_235(plParam1))
		{
			...
			if (num2 != -1 && unk_0x834C960822A4683F() && num2 < 4)
				if (Global_4718592.f_112316[num2] != -1)
					unk_0x4E5A3D96808F7F84(func_200(num2, plParam1, false));
				else
					unk_0x4E5A3D96808F7F84(func_252(plParam1, -2, true, false, false));
			else
				unk_0x4E5A3D96808F7F84(func_252(plParam1, -2, true, false, false));
			...
			{
				Global_2764376 = { func_182(plParam1) };
...
int func_200(int iParam0, Player plParam1, BOOL bParam2) // Position - 0xD74C
{
	int num;
	int num2;
	int num3;
	...
	if (iParam0 > -1 && plParam1 != _INVALID_PLAYER_INDEX())
	{
		...
		if (IS_BIT_SET(Global_4718592.f_15, 26) && !func_202(iParam0, unk_0x1864096A95E36EBA(plParam1), 0, -1))
			num = func_201(true);
	}
	else
	{
...
int func_252(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFBF3
{
	int num;
	var unk;
					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0x1C1C92A1CBAE364B(unk), false, true))
						if (iParam1 > -1 && unk_0x834C960822A4683F() && iParam1 < 4)
							if (Global_4718592.f_112316[iParam1] != -1)
								...
								return func_254(plParam0, unk_0x1C1C92A1CBAE364B(unk), iParam1, bParam2, bParam3);
						else
							return func_254(plParam0, unk_0x1C1C92A1CBAE364B(unk), iParam1, bParam2, bParam3);
	...
	if (iParam1 > -1 && unk_0x834C960822A4683F() && iParam1 < 4)
		if (Global_4718592.f_112316[iParam1] != -1)
			...
			return func_254(plParam0, unk_0x259BE71D8A81D4FA(), iParam1, bParam2, bParam3);
...
int func_254(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFDF4
{
	int num;
	BOOL flag;
	Player player;
	...
	if (!flag)
	{
		if (num != -1)
		{
			...
			if (func_255(plParam1, plParam0, num, 0) && !IS_BIT_SET(Global_4718592.f_15, 18) || func_202(unk_0x1864096A95E36EBA(plParam1), unk_0x1864096A95E36EBA(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.f_15, 23) && !IS_BIT_SET(Global_4718592.f_15, 18))
				return func_210(true);
			else if (IS_BIT_SET(Global_4718592.f_15, 26))
				return func_201(true);
			else
				return func_206(plParam1, true, num, bParam4);
		}
...
void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x10446
{
	int num;
