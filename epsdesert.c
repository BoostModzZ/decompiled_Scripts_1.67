...
void func_1() // Position - 0xD6
{
	...
	if (Global_113810.f_10052.f_107 < fLocal_210)
	{
		...
		if (bLocal_204)
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_36))
			{
		...
		if (bLocal_205)
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_37))
			{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x1FD16
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1FF36
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x207FA
{
	if (iParam2 == -1)
		iParam2 = func_59();
