...
void func_2() // Position - 0xCE5
{
	...
	if (player > -1 && player != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 30; i = i + 1)
		{
			if (Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_267.f_33 == Global_1853988[player /*867*/].f_267[i])
			{
				if (func_9(i) != -1)
				{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x1491
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x22BE
{
	switch (func_66())
	{
		case 0:
