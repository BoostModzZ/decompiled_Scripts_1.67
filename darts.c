...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x62B9
{
	if (iParam2 == -1)
		iParam2 = func_66();
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6B1F
{
...
int func_96(eCharacter echParam0) // Position - 0x6B44
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xB36B
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x211C4
{
...
eCharacter func_450(var uParam0) // Position - 0x21604
{
	eCharacter i;
	int num;
	eCharacter character;
...
int func_451(eCharacter echParam0) // Position - 0x2164A
{
...
var func_473(eCharacter echParam0, int iParam1) // Position - 0x221A1
{
	var unk;
	var unk2;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x23E97
{
	eCharacter i;
	int num;
