...
BOOL func_173(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x25DDC
{
	int num;
...
int func_175(eCharacter echParam0) // Position - 0x25EB0
{
