...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x2024B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x20288
{
...
int func_170(eCharacter echParam0) // Position - 0x202AD
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0x27A64
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_257() // Position - 0x28932
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Jimmy_Boston", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[1]) && func_293(iLocal_360))
				{
...
void func_258() // Position - 0x289EE
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Marnie", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]) && func_293(iLocal_360))
				{
					unk_0xB5396F1FB088FE38(&uLocal_780);
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x28E7D
{
...
BOOL func_270(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x29332
{
	int i;
	var unk;
	int num;
...
void func_304(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x2B6BB
{
	eCharacter character;
...
void func_305(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x2BC04
{
	eCharacter character;
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			else if (uParam0->f_2 == 1)
			{
				...
				{
					if (iLocal_756 < 4 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541() && !bLocal_335 && !func_354())
					{
						if (*uParam0 == uLocal_604[1 /*8*/])
						{
...
{
	if (func_353(iParam0) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
		if (iLocal_621 == 0)
		{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2E883
{
...
BOOL func_412(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x313B6
{
	if (func_413(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_413(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x31412
{
	int num;

	if (!func_171(echParam1))
	{
		num = func_444(echParam1);
...
int func_444(eCharacter echParam0) // Position - 0x31E67
{
