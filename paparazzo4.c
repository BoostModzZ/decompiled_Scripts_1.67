...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x2CE0C
{
...
void func_340(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x2CE87
{
	...
	if (unk_0xFC8BFE4B41177C22(unk))
	{
		...
		if (unk_0xD9F5E1FEFD1329E4(unk, 0))
		{
			...
			if (bParam16)
				if (func_342(unk, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL func_342(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2D2A7
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_343(echParam1, i, &unk, &num); i = i + 1)
	{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2E0F8
{
...
BOOL func_397(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2F6BA
{
	if (func_398(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_398(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2F716
{
	int num;

	if (!func_155(echParam1))
	{
		num = func_437(echParam1);
...
int func_437(eCharacter echParam0) // Position - 0x3052A
{
