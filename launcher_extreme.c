...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3B04
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x404D
{
	eCharacter character;
...
int func_181(var uParam0) // Position - 0xC2D4
{
	if (*uParam0 == 18)
	{
		if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, 0, 1, 0))
		{
			...
			else if (!func_182(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_157(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 3f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD579
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6D5
{
...
BOOL func_262(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF8FB
{
...
BOOL func_263(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF957
{
	int num;
...
int func_298(eCharacter echParam0) // Position - 0x107DC
{
	if (!func_36(echParam0))
