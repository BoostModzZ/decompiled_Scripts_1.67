...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1FCE0
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FD1D
{
...
int func_160(eCharacter echParam0) // Position - 0x1FD42
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x27886
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x27F5B
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x289E3
{
...
BOOL func_259(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x28ECD
{
	int i;
	var unk;
	int num;
			...
			if (func_322(unk_0x4A8C381C258A124D()))
			{
				if (func_322(uLocal_153))
				{
					...
					if (func_321(unk_0x4A8C381C258A124D(), uLocal_153, 32f, 1))
					{
						...
						{
							if (!bLocal_376)
								if (func_321(unk_0x4A8C381C258A124D(), uLocal_153, 30f, 1) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
...
void func_301() // Position - 0x2AA50
{
	...
	if (!_IS_MISSION_REPLAY_IN_PROGRESS() && func_322(uLocal_80.f_28[0]) && func_322(unk_0x4A8C381C258A124D()) && bLocal_381 == true)
	{
...
void func_323() // Position - 0x2B797
{
	...
	uLocal_153.f_5 = func_382(CHAR_DOM);
	...
	{
		func_324(&uLocal_153, CHAR_DOM, uLocal_153.f_1, uLocal_153.f_4, "Ext4-Dom", 1);
...
int func_324(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, char* sParam6, int iParam7) // Position - 0x2B974
{
	if (func_325(uParam0, echParam1, uParam2, uParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_325(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x2B9D0
{
	int num;

	if (!func_161(echParam1))
	{
		num = func_382(echParam1);
...
int func_382(eCharacter echParam0) // Position - 0x2CBBB
{
